	...
	return AgentProtocolContract{
		...
		WebSocket: AgentProtocolWebSocket{
			...
			ClientSends: []AgentProtocolEvent{
				...
				{Type: AgentEventTerminalReplay, Required: []string{"type", "session_id", "encoding", "data", "seq", "final", "status"}, Optional: []string{"truncated"}},
				{Type: AgentEventTerminalSessions, Required: []string{"type", "sessions"}},
			...
			ServerSends: []AgentProtocolEvent{
				...
				{Type: AgentEventTerminalCreate, Required: []string{"type", "session_id"}, Optional: []string{"shell", "cwd", "rows", "cols", "attach"}, Emits: []string{AgentEventTerminalCreated, AgentEventTerminalReplay, AgentEventTerminalOutput, AgentEventTerminalExit, AgentEventTerminalError}},
